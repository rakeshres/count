...
/**
 * @author bipin on 7/11/19 1:45 PM.
 */
public interface EntityApproveService {
    Entity approve(AuditLogEntity auditLogEntity, AuditDao auditDao, Entity entity, AbstractRepository dao,
                   RabbitRequestContext rabbitRequestContext,boolean autoApproveEnabled);
}
